...
int screenDelay = 500, screenPartDelay = 50, rcvLen;
...
void updateScreenShot(CScreenShot* screenShot, int delay, u16* vram) {
	u8 tmp;
	//Request Screen//
	screenDelay++;
...
//	connect(sock,(struct sockaddr *)&saout,sizeof(saout));
