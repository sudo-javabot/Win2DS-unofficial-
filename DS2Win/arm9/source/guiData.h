...
const WindowData WND_MAINMENU = {
	5, 6, 26, 16, "Win2DS Main Menu"
};
const GUIData SEL_MAIN1 = {
	8, 10, 23, 10, "Auto Connect"
};
const GUIData SEL_MAIN2 = {
	8, 12, 23, 12, "Manual Connect"
};
...
const WindowData WND_ABOUT = {
	1, 7, 30, 16, "About Win2DS"
};
const GUIData LBL_ABOUT1 = {
	3, 11, 28, 11, "Win2DS v0.5"
};
const GUIData LBL_ABOUT2 = {
	3, 12, 28, 12, "By Bill Blaiklock"
};
const GUIData LBL_ABOUT3 = {
	3, 14, 28, 14, "sintax@digitalAtrocity.com"
};
